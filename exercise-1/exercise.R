...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = price, y = carat, shape = factor(cut)))
...
ggplot(data = diamonds.sample) + geom_line(mapping = aes(x = carat, y = price, color = carat, sm))
